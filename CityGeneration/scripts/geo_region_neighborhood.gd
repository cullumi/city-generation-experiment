...
var path_height = Convert.ft_to_m(0.5)
var variance = 7.5
var avg_struct_height = Convert.ft_to_m(45)
var avg_struct_length = Convert.ft_to_m(18)
var avg_path_width = Convert.ft_to_m(10)
...
func rand_path_width(): return rand_from_avg(variance, avg_path_width)
func rand_struct_height(): return rand_from_avg(variance, avg_struct_height)
func rand_struct_length(): return rand_from_avg(variance, avg_struct_length)
